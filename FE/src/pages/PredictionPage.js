        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={handlePred}>
            ...
            <div className="text-center">
              <p>(예시 데이터)</p>
              <p> Machinery : NO.1 GENERATOR ENGINE</p>
              <p>Assembly : 323-6480 LINES GP-FUEL</p>
              <p>Company : HAEIN Coporation_Cheonan</p>
              <p>Part No.1 : 7.00E-275</p>
              <p>Part No.2 : 0</p>
              <p>청구품목 : SEAL-O-RING-STOR</p>
            </div>
